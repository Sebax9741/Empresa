...
- Despachos de pedidos: cada despacho es un pedido / una boleta que sale a reparto (cliente elegido de la base, N° de comprobante, monto, fecha de despacho editable y uno o varios repartidores de una lista de solo nombres) con un estado (en reparto / a crédito / al contado / devuelto); la boleta que vuelve firmada abre el formulario de crédito prellenado y queda enlazada al crédito creado, donde se guardan la foto de la boleta firmada y las notas.
