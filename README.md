...
- 📦 **Despachos: el recorrido completo de cada venta** (botón 📦). Las **notas de venta** que emites aparecen ahí solas, marcadas 📝 *Nota de venta*: **tócalas y se abre el despacho con el cliente, la zona, el número y el monto ya puestos** — solo eliges quién la lleva y qué día. Al salir pasa a 🚚 *En reparto*. Cuando el reparto vuelve dices qué pasó: la boleta **volvió firmada** (abre el **formulario de crédito ya prellenado** y los dos quedan **enlazados**), **se pagó al contado**, o fue **devuelta**; cualquiera de las tres se puede deshacer volviendo a "en reparto". Todo se busca por día, con el resumen de cuántas ventas hay en cada estado y el monto. La **hoja que se llevan los repartidores** solo imprime lo que sale de verdad: las notas sin asignar no van
