...
- 🖥️ **Ventanas grandes en computadora**: **editar un crédito** se abre a dos columnas (los datos a la izquierda; los pagos a cuenta, las notas y la foto a la derecha), así cabe entero sin bajar con la rueda. Y la **ficha del crédito** se ajusta a lo que hay: si no tiene foto o ya está pagado no reserva esa columna, y si le faltan las dos se estrecha, en vez de dejar huecos en blanco
