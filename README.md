...
- 🔢 **Tres series, una por grupo de zonas**: **0001** para CIUDAD, MODELO, CARRETERA, 3 DE MAYO, MILAGROS, PADRE ALDAMIZ y ALAMEDA; **0002** para LABERINTO; **0003** para PAMPA. La serie **se elige sola al elegir el cliente**, según su zona, y se puede **cambiar a mano** en el mismo número (para el que llega al mostrador desde otra zona). Cada serie lleva **su propio correlativo**, como en un talonario aparte: la 0002 va por su cuenta aunque la 0001 esté mucho más adelante
