...
- 🖨️ **Nota de venta impresa en media hoja A4 puesta de pie** (A5 vertical, 148 × 210 mm: cortas la A4 por la mitad y usas cada mitad en vertical), con el mismo formato de tu talonario: cabecera del negocio y número de nota en su recuadro, datos del cliente y del comprobante, cuadro de **Código / Cant. / U.M. / Descripción / P.U. / Importe** (más **Dscto. bonif.** si la nota lleva alguna), la línea **"Son: … CON 00/100 SOLES"** y los recuadros de **Total Dscto** y **Total a Pagar**. En la hoja caben hasta **26 productos** sin pasar a una segunda. El nombre, la dirección, el RUC y el teléfono del negocio se ponen en ⚙️ Configuración. En la impresora, elige tamaño **A5** y **vertical**
