...
- 🛒 **Productos** (botón 🛒): catálogo con **código de producto** (000001, 000002… se genera solo), **nombre**, **presentación** (Balde, Caja, Saco, Paquete o Unidad) y **tres precios: A, B y C**. Cada producto lleva su **stock mínimo** para que la app avise cuando se está acabando, y se puede marcar como **inactivo** para que deje de salir al vender sin perder su historial
- 📒 **Kardex de almacén** (botón 📒): el registro de **todo lo que entra y sale**. Cada movimiento anota **fecha y hora, producto, tipo (📥 entrada / 📤 salida / ⚖️ ajuste), motivo** (compra a proveedor, devolución de cliente, venta, merma, traslado, conteo físico), **documento de referencia** (nº de factura o de nota de venta), **cuánto entró o salió, el saldo que quedó** y **quién lo registró**. El stock **nunca se escribe a mano**: sale de sumar el kardex, así que siempre se puede auditar fila por fila. En un **ajuste** escribes lo que contaste de verdad en el almacén y la app calcula sola la diferencia. Se filtra por producto, tipo y rango de fechas, y se puede **imprimir**
