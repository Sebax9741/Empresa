...
- 🧾 **Hojas de cobranza por día** (botón 🧾): **cada día tiene su propia hoja**. Todos los pagos "a cuenta" que se registran caen automáticamente en la hoja del día que les toca. Cada línea dice **a qué cliente** (con su código), **a qué crédito** (Nº de boleta), **cuánto se cobró**, **cuánto queda debiendo**, **si fue Efectivo / Yape / BCP**, **quién lo cobró** y **su firma**. Arriba, los **totales por método** y el total del día. Con **◀ ▶** saltas entre los días que tienen cobros y una lista muestra todos los días con su total. Tocando una línea se abre el crédito completo. Se puede **imprimir** o **exportar a Excel**
